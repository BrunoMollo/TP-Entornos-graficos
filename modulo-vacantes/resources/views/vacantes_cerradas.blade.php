<x-layout>
    <div class="container">
        <div class="row justify-content-center">
            <h2 class="m-2 col-12 col-sm-6 text-center">Listado de vacantes cerradas</h2>
        </div>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"> <button class="btn btn-primary">Ver Órden de Mérito</button></td>
                </tr>
                @endforeach
            </tbody>
        </table>
